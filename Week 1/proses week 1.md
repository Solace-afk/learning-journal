...
## Kesimpulan Pribadi
Secara keseluruhan, materi di minggu pertama memberikan landasan fundamental dan pola pikir yang sangat penting sebelum saya benar-benar terjun ke praktik teknis. Kesimpulan terbesar saya adalah bahwa keahlian *Reverse Engineering* ibarat pedang bermata dua. Memiliki kemampuan untuk membongkar sistem tertutup harus selalu diimbangi dengan integritas moral dan kepatuhan terhadap hukum (seperti DMCA atau UU ITE). Materi pembuka ini menyadarkan saya bahwa menjadi seorang periset keamanan (*security researcher*) bukan sekadar tentang seberapa hebat kita membaca kode *binary* atau mengoperasikan Ghidra, melainkan juga seberapa bertanggung jawab kita dalam memanfaatkan pengetahuan tersebut demi meningkatkan keamanan, bukan untuk mengeksploitasinya secara destruktif.